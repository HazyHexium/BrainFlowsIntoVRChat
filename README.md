...
1. Install [Python 3.11.5](https://www.python.org/downloads/release/python-3115/)
2. Download [BFiVRC.Zip](https://github.com/ChilloutCharles/BrainFlowsIntoVRChat/releases/tag/0.2.0) project to a folder and copy the folder path
